...
To do so, add @gem "daemons"@ to your @Gemfile@ and make sure you've run `script/generate delayed_job`.
...
!http://travis-ci.org/collectiveidea/delayed_job.png!

h2. Dependency Status

!https://gemnasium.com/collectiveidea/delayed_job.png?travis!
